...
Addstudent=()=>{  
  axios.post('https://localhost:44338/Api/Registers', {id:this.state.id,FirstName:this.state.FirstName,LastName:this.state.LastName,Email:this.state.Email,Password:this.state.Password,ConfirmPassword:this.state.ConfirmPassword,})  
.then(json => {  
    ...
    <Form className="form1">  
      <Col>  
        ...
        <FormGroup row>  <br></br> 
          ...
          <Col sm={10}>  
            <Input type="" name="Password" onChange={this.handleChange} value={this.state.Password} placeholder="Enter Password" />  
          </Col>  
        </FormGroup>  
        <FormGroup row> <br></br>  
